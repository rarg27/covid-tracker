...
class FillPermissionsForTransportationLog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTransportationLog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.transportation-log',
            'admin.transportation-log.index',
            'admin.transportation-log.create',
            'admin.transportation-log.show',
            'admin.transportation-log.edit',
            'admin.transportation-log.delete',
            'admin.transportation-log.bulk-delete',
        ]);
