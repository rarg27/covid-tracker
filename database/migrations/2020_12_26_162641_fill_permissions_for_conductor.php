...
class FillPermissionsForConductor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConductor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.conductor',
            'admin.conductor.index',
            'admin.conductor.create',
            'admin.conductor.show',
            'admin.conductor.edit',
            'admin.conductor.delete',
            'admin.conductor.bulk-delete',
        ]);
