...
class FillPermissionsForTerminal extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTerminal constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.terminal',
            'admin.terminal.index',
            'admin.terminal.create',
            'admin.terminal.show',
            'admin.terminal.edit',
            'admin.terminal.delete',
            'admin.terminal.bulk-delete',
        ]);
